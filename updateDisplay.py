...
def loadTasksFromWiki(content): #content is the string page content
    lines = content.split('\n')
    ...
    for elem in table:
        try:
            taskID, name, emojii, progress, assignee, dueDateStr, lastUpdateStr, statusMsg = elem.split("|")[1:-1] 
        except ValueError:
